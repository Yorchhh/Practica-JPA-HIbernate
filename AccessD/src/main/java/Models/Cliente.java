...
public class Cliente implements Serializable{
	...
	public Cliente(int codigo_cliente, String nombre_cliente, String nombre_contacto, String apellido_contacto,
			...
			String pais, String codigo_postal, int codigo_empleado_rep_ventas, int limite_credito) {
		super();
	...
	public String toString() {
		return "Codigo_cliente=" + codigo_cliente + ", nombre_cliente=" + nombre_cliente + ", nombre_contacto="
